...
echo "set(TOOLCHAIN_PATH /home/public/tool_chain/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf//bin)" >> $EXTERN_LIB_CMAKE
echo "set(CMAKE_C_COMPILER /home/public/tool_chain/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf//bin/arm-linux-gnueabihf-gcc)" >> $EXTERN_LIB_CMAKE
echo "set(CMAKE_C_FLAGS "-I/include")" >> $EXTERN_LIB_CMAKE
echo "set(CMAKE_CXX_COMPILER /home/public/tool_chain/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf//bin/arm-linux-gnueabihf-gcc)" >> $EXTERN_LIB_CMAKE
