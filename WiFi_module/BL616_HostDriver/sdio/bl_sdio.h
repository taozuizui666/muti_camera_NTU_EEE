...
#define CARD_IO_ABORT           0x06
#define CARD_BUS_CTRL           0x07
...
#define MAX_AGG_BUF         8
#define NA_DATA_PORT_NUM    1
...
/* Card IO Abort Registers: System reset without SDU reset */
#define CARD_SYS_RESRT              (0x1U << 3)
/* Bus Control Registers  : Trigger SDIO IRQ */
#define CARD_SDIO_IRQ               (0x1U << 4)
...
static const struct bl_sdio_card_reg bl_reg_sd616 = {
    .start_rd_port = 1,
    .start_wr_port = 1,
    .base_0_reg = 0x0040,
    .base_1_reg = 0x0041,
