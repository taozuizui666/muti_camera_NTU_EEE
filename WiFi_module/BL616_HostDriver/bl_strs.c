...
static const char *const bl_mmid2str[MSG_I(MM_MAX)] = {
    ...
    [MSG_I(MM_TEMP_READ_CFM)]             = "MM_TEMP_READ_CFM",                      //110           
    // read rssi
    [MSG_I(MM_GET_RSSI_REQ)]              = "MM_GET_RSSI_REQ",
    [MSG_I(MM_GET_RSSI_CFM)]              = "MM_GET_RSSI_CFM",    
    // read efuse
    [MSG_I(MM_READ_EFUSE_REQ)]            = "MM_READ_EFUSE_REQ",
    [MSG_I(MM_READ_EFUSE_CFM)]            = "MM_READ_EFUSE_CFM",
    //set phy misc cmd, like cca test cmd, need phylib support, or no effect
    [MSG_I(MM_SET_PHY_MISC_REQ)]          = "MM_SET_PHY_MISC_REQ",
    [MSG_I(MM_SET_PHY_MISC_CFM)]          = "MM_SET_PHY_MISC_CFM",    
   
    [MSG_I(MM_BBP_START_REQ)]             = "MM_BBP_START_REQ",
    [MSG_I(MM_BBP_STOP_REQ)]              = "MM_BBP_STOP_REQ",
};
...
static const char *const bl_dbgid2str[MSG_I(DBG_MAX)] = {
    ...
    [MSG_I(DBG_COEX_RW_PARAM_REQ)]   = "DBG_COEX_RW_PARAM_REQ",
    [MSG_I(DBG_COEX_RW_PARAM_CFM)]   = "DBG_COEX_RW_PARAM_CFM",

    [MSG_I(DBG_BTBLE_UART_BAUD_REQ)] = "DBG_BTBLE_UART_BAUD_REQ",
    [MSG_I(DBG_BTBLE_UART_BAUD_CFM)] = "DBG_BTBLE_UART_BAUD_CFM",
    
#ifdef BL_BUS_LOOPBACK
    [MSG_I(DBG_LBK_REQ)]             = "DBG_LBK_REQ",
    [MSG_I(DBG_LBK_CFM)]             = "DBG_LBK_CFM",
#endif

    [MSG_I(DBG_MP_REQ)]              = "DBG_MP_REQ",
    [MSG_I(DBG_MP_CFM)]              = "DBG_MP_CFM",

    [MSG_I(DBG_UPDATE_FW_VAR)]       = "DBG_UPDATE_FW_VAR",
    [MSG_I(DBG_FW_ACT_REQ)]          = "DBG_FW_ACT_REQ",
    [MSG_I(DBG_FW_ACT_IND)]          = "DBG_FW_ACT_IND",

    [MSG_I(DBG_KE_STAT_REQ)]         = "DBG_KE_STAT_REQ",
    [MSG_I(DBG_KE_STAT_CFM)]         = "DBG_KE_STAT_CFM",
    [MSG_I(DBG_MP2_REQ)]             = "DBG_MP2_REQ",
    [MSG_I(DBG_MP2_CFM)]             = "DBG_MP2_CFM",
};
...
static const char *const bl_meid2str[MSG_I(ME_MAX)+7] = {
    ...
    [MSG_I(ME_MISC_REQ)]             = "ME_MISC_REQ",
    [MSG_I(ME_MISC_CFM)]             = "ME_MISC_CFM",
};
...
static const char *const bl_twtid2str[MSG_I(TWT_MAX)] = {
