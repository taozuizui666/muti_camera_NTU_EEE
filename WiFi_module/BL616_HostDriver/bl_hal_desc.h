 ...
 * HW type
 ******************************************************************************/
#define BL_MACHW_NX 1
#define BL_MACHW_HE 2
...
#define N_HE_DCM_RATE_IDX_BASE  (4000)
...
extern const struct bl_legrate legrates_lut[];
...
struct tx_cfm_tag
{
    ...
    s8_l credits;
    u8_l ampdu_size;
//mask the MACRO to sync with FW
...
#define BL_RX_HD_NX_DECR_UNENC           0 // Frame unencrypted
#define BL_RX_HD_NX_DECR_ICVFAIL         1 // WEP/TKIP ICV failure
#define BL_RX_HD_NX_DECR_CCMPFAIL        2 // CCMP failure
#define BL_RX_HD_NX_DECR_AMSDUDISCARD    3 // A-MSDU discarded at HW
#define BL_RX_HD_NX_DECR_NULLKEY         4 // NULL key found
#define BL_RX_HD_NX_DECR_WEPSUCCESS      5 // Security type WEP
#define BL_RX_HD_NX_DECR_TKIPSUCCESS     6 // Security type TKIP
#define BL_RX_HD_NX_DECR_CCMPSUCCESS     7 // Security type CCMP (or WPI)

/* Decryption status subfields. (HE hardware) */
#define BL_RX_HD_DECR_UNENC     0 // Frame unencrypted
#define BL_RX_HD_DECR_WEP       1 // Security type WEP
#define BL_RX_HD_DECR_TKIP      2 // Security type TKIP
#define BL_RX_HD_DECR_CCMP128   3 // Security type CCMP (128 bits)
#define BL_RX_HD_DECR_CCMP256   4 // Security type CCMP (256 bits)
#define BL_RX_HD_DECR_GCMP128   5 // Security type GCMP (128 bits)
#define BL_RX_HD_DECR_GCMP256   6 // Security type GCMP (256 bits)
#define BL_RX_HD_DECR_WAPI      7 // Security type WAPI
#define BL_RX_HD_DECR_NULLKEY  15 // NULL key found
...
/* Used for both Hardware type (but for NX Hardware rx_vectx and status fileds
   must be converted first using bl_xxxx_convert function).
